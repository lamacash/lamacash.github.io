...
Основное общение ведётся в топике "Болталка", а то, что связано с багами/проблемами, обсуждается в топике "Тестировочная".
:::
...
Под понятием "флуд" подразумевается: длинные сообщения, состоящие из одних смайликов/повторяющихся символов.
:::
## Ссылочки:
